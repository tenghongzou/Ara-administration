...
│   ├── PaymentHistoryList.svelte
│   ├── SubscriptionCard.svelte
│   ├── CategoryBreakdown.svelte
│   └── CalendarStatsPanel.svelte
│
...
**使用方式：**
```typescript
import { StatsGrid, ActivityFeed } from '$lib/modules/dashboard';
import { StatsCards, SubscriptionCard } from '$lib/modules/subscriptions';
import { NotificationList, NotificationFilters } from '$lib/modules/notifications';
import { UserFiltersPanel, UserCard, UserForm } from '$lib/modules/users';
import { RoleCard, PermissionSelector, RoleForm } from '$lib/modules/roles';
import { SettingsModuleCard, ThemeSelector, QuietHoursModal } from '$lib/modules/settings';
```
